...
/* Generated from ../O.Common/srcextr.dbd */
...
int srcextr_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/usr/local/cnts-3.14.12/epics-3.14.12/operations/opIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"srcextr_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    srcextr_registerRecordDeviceDriver(*iocshPpdbbase);
}
